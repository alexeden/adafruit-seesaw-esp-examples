...
//     let i2c = I2cDriver::<'static>::new(peripherals.i2c0, sda, scl,
// &config)?;     i2c_power.set_high()?;
...
//     loop {
//         // let position = encoder.position().expect("Failed to get
// position");         // let c = color_wheel(((position & 0xFF) as
// u8).wrapping_mul(3));         // let Color(r, g, b) = c.set_brightness(255);
